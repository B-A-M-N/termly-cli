...
function displayPairingUI(pairingCode, serverUrl, aiTool, aiToolVersion, projectName, computerName, label = null) {
  const qrData = generateQRData(pairingCode, serverUrl, aiTool, projectName, label);
